...
{
public:
	Link(const char* lnk_path, const char* lnk_description, const char* lnk_target);
	std::string lnk_path;
...
public:
	...
	bool create_startup_folder_link(const char* lnk_name, const char* lnk_description, const char* lnk_target);
